...
<head>
    ...
    <title>{{ config('app.name', 'Rida Manis') }}</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
            ...
            <div class="sidebar-brand-text mx-3">Rida Manis <sup></sup></div>
        </a>
        ...
        @endauth
        @auth
            @if (auth()->user()->jenis == 3)
                <li class="nav-item {{ Nav::isRoute('pax.index') }}">
                    <a class="nav-link" href="{{ route('pax.index') }}">
                        <i class="fas fa-fw fa-plus"></i>
                        <span>{{ __('pax Ketos') }}</span>
                    </a>
                </li>
                <li class="nav-item {{ Nav::isRoute('hasilpemilihan.index') }}">
                    <a class="nav-link" href="{{ route('hasilpemilihan.index') }}">
        ...
        @endauth
        @auth
            @if (auth()->user()->jenis == 2)
                <li class="nav-item {{ Nav::isRoute('pemilihan.index') }}">
                    <a class="nav-link" href="{{ route('pemilihan.index') }}">
                        <i class="fas fa-fw fa-plus"></i>
                        <span>{{ __('Voting') }}</span>
                    </a>
                </li>
